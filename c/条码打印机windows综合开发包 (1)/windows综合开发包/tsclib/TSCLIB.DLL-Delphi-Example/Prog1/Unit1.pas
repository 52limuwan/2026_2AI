...
openport('TSC CLEVER TTP-243');
        for i:=1 to 2 do
         begin
          ...
          windowsfont(5, 115, 30, 0, 2, 0, '新細明體', pchar('財產名稱：印表機'));
          windowsfont(5, 150, 30, 0, 2, 0, '新細明體', pchar('使用單位：教務處'));
          windowsfont(5, 190, 30, 0, 2, 0, '新細明體', pchar('登帳日：92/08'));
          windowsfont(5, 255, 30, 0, 2, 0, '新細明體', pchar('最低耐用年限：5 年'));
          windowsfont(5, 290, 30, 0, 2, 0, '新細明體', pchar('財產編號：3140302001-2038'));
