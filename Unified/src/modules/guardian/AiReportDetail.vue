  ...
  <div class="card-list">
    ...
    <div v-else-if="report" class="report-detail">
      ...
      <div class="analysis-card">
        <h3 class="section-title">AI 专业分析与建议</h3>
...
import { getAiDietReportById } from '../../api/guardian'
...
const loadReport = async () => {
  ...
  try {
    ...
    const reportId = parseInt(route.params.reportId)
    const response = await getAiDietReportById(clientId, reportId)
