...
康小伴是一个面向社区养老服务的智能助餐平台，通过AI技术为老年人提供个性化营养管理、健康监测和智能点餐服务。系统采用四端分离架构，包含销售端、监护人端、商户端和政府端，实现了从点餐、配送到营养分析的全流程数字化管理。
...
### 6. Agent Skill 智能技能识别系统

Agent Skill 是一个创新的AI技能识别系统，能够根据用户提问的关键词自动识别并激活相应的专业技能角色，为不同端的用户提供更精准、更专业的服务。

#### 系统概述

**核心特性**:
- 关键词智能匹配 - 实时分析用户输入，自动识别意图
- 技能角色切换 - 根据问题类型动态切换AI专业角色
- 视觉反馈动画 - 优雅的模糊动画展示技能激活过程
- 多端差异化 - 监护人端和政府端配置不同的技能角色
- 无缝集成 - 与现有AI聊天系统完美融合
...
监护人端配置了9个专业技能角色，覆盖家庭养老护理的各个方面:

**1. 营养分析师**
- 关键词覆盖: 营养分析、营养报告、营养评估、蛋白质、脂肪、碳水、维生素、矿物质、热量、卡路里、营养不良、营养缺口、饮食建议等
- 专业领域: 深度营养分析、膳食结构评估、营养素缺口识别、改善方案制定
- 典型问题: "老人最近营养够吗？"、"需要补充什么营养？"、"如何改善饮食结构？"

**2. 健康监护顾问**
- 关键词覆盖: 健康监测、血压、血糖、血脂、心率、异常、不正常、症状、风险预警、就医建议等
- 专业领域: 健康指标监测、异常识别、风险评估、就医指导
- 典型问题: "血压偏高怎么办？"、"这个指标正常吗？"、"需要去医院吗？"

**3. 慢病协同管理师**
- 关键词覆盖: 慢性病、三高、高血压、糖尿病、用药、服药、遵医嘱、指标控制、并发症预防等
- 专业领域: 慢性病管理、用药监督、指标控制、并发症预防
- 典型问题: "如何监督老人按时吃药？"、"血糖控制不住怎么办？"、"如何预防并发症？"

**4. 心理关怀指导师**
- 关键词覆盖: 心理、情绪、心情、焦虑、孤独、沟通、交流、陪伴、代沟、心理支持等
- 专业领域: 情绪识别、心理疏导、沟通技巧、陪伴方法
- 典型问题: "老人情绪低落怎么办？"、"如何与老人沟通？"、"怎么陪伴老人？"

**5. 居家安全顾问**
- 关键词覆盖: 安全、危险、跌倒、摔倒、改造、适老化、扶手、防滑、辅助设备、预防措施等
- 专业领域: 居家安全评估、环境改造建议、辅助设备推荐、跌倒预防
- 典型问题: "如何防止老人跌倒？"、"家里需要做哪些改造？"、"需要什么辅助设备？"

**6. 护理技能培训师**
- 关键词覆盖: 护理、照顾、洗澡、穿衣、喂饭、如厕、翻身、褥疮、伤口护理、护理方法等
- 专业领域: 日常护理指导、专业技能培训、护理问题解决
- 典型问题: "如何给老人洗澡？"、"怎么预防褥疮？"、"伤口如何护理？"

**7. 就医陪诊助手**
- 关键词覆盖: 就医、看病、挂号、检查、化验、医患沟通、取药缴费、复诊随访等
- 专业领域: 就医准备、流程指导、医患沟通、复诊管理
- 典型问题: "去医院需要准备什么？"、"挂什么科？"、"如何与医生沟通？"

**8. 康复计划师**
- 关键词覆盖: 康复、康复训练、功能训练、恢复、锻炼、康复进度、康复目标、理疗等
- 专业领域: 康复评估、训练计划、进度跟踪、目标设定
- 典型问题: "如何进行康复训练？"、"康复进度正常吗？"、"能恢复到什么程度？"

**9. 养老资源顾问**
- 关键词覆盖: 养老、养老院、养老服务、居家养老、社区养老、费用价格、政策补贴等
- 专业领域: 养老方式咨询、机构对比、政策解读、资源推荐
- 典型问题: "选择什么养老方式？"、"养老院怎么选？"、"有什么补贴政策？"

**10. 家庭沟通协调师**
- 关键词覆盖: 家庭、子女、责任分工、矛盾纠纷、沟通协调、经济问题、情感维系等
- 专业领域: 家庭关系协调、责任分配、矛盾调解、决策支持
- 典型问题: "如何分配照顾责任？"、"家庭意见不一致怎么办？"、"如何协调家人关系？"

#### 政府端技能角色

政府端配置了10个专业技能角色，聚焦社区健康管理和政策执行:

**1. 社区健康管理师**
- 关键词覆盖: 社区健康、社区管理、人群健康、健康数据、统计分析、风险管理、干预措施等
- 专业领域: 社区健康评估、人群管理、数据分析、干预方案制定
- 典型问题: "如何提升社区整体健康水平？"、"如何识别高危人群？"、"制定干预方案"

**2. 慢病防控专家**
- 关键词覆盖: 慢性病、慢病防控、三高、筛查、早期发现、健康教育、防控策略等
- 专业领域: 慢病防控策略、筛查体系、健康教育、效果评估
- 典型问题: "如何开展慢病防控？"、"筛查工作怎么做？"、"如何提高控制率？"

**3. 营养政策顾问**
- 关键词覆盖: 营养政策、政策制定、营养改善、方案设计、资源配置、效果监测等
- 专业领域: 政策制定、方案设计、资源配置、效果评估
- 典型问题: "如何制定营养政策？"、"方案如何设计？"、"资源如何配置？"

**4. 健康教育专家**
- 关键词覆盖: 健康教育、健康宣教、讲座、培训、宣传材料、行为改变、效果评价等
- 专业领域: 教育活动组织、材料制作、行为干预、效果评估
- 典型问题: "如何开展健康教育？"、"活动怎么组织？"、"如何提高知晓率？"

**5. 养老服务监管师**
- 关键词覆盖: 服务监管、质量监管、养老机构、检查、评估、问题处理、标准制定等
- 专业领域: 服务质量监管、标准制定、问题处理、质量提升
- 典型问题: "如何监管养老机构？"、"检查重点是什么？"、"如何处理投诉？"

**6. 应急响应协调师**
- 关键词覆盖: 应急、突发事件、应急预案、应急响应、应急处置、资源调度等
- 专业领域: 应急预案制定、快速响应、资源调度、事后总结
- 典型问题: "如何应对突发事件？"、"应急流程是什么？"、"资源如何调度？"

**7. 数据分析师**
- 关键词覆盖: 数据、数据分析、统计、趋势分析、可视化、结论建议、决策支持等
- 专业领域: 数据统计分析、趋势预测、可视化呈现、决策支持
- 典型问题: "如何分析健康数据？"、"趋势是什么？"、"数据如何应用？"

**8. 资源配置优化师**
- 关键词覆盖: 资源配置、资源分配、需求分析、配置方案、效率效益、动态管理等
- 专业领域: 资源需求分析、配置方案设计、效率优化、动态调整
- 典型问题: "如何优化资源配置？"、"配置原则是什么？"、"如何提高效率？"

**9. 政策法规顾问**
- 关键词覆盖: 政策、法规、政策解读、合规管理、申请审批、法律风险等
- 专业领域: 政策解读、合规指导、流程咨询、风险防范
- 典型问题: "政策如何理解？"、"如何合规执行？"、"申请流程是什么？"

**10. 社区协作促进师**
- 关键词覆盖: 协作、合作、联动、资源整合、协作机制、问题协调、共赢发展等
- 专业领域: 协作机制建设、资源整合、问题协调、模式推广
- 典型问题: "如何促进多方协作？"、"协作机制怎么建？"、"如何解决协作问题？"
...
系统: [识别到"营养"、"补充"关键词]
      [激活"营养分析师"技能]
      [显示动画: "查看技能 营养分析师" → "读取技能 营养分析师"]
AI回复: 作为营养分析师，我来为您分析老人的营养状况...
```

**政府端场景**:
```
用户: "如何提升社区居民的整体健康水平？"
系统: [识别到"社区"、"健康水平"、"提升"关键词]
      [激活"社区健康管理师"技能]
      [显示动画: "查看技能 社区健康管理师" → "读取技能 社区健康管理师"]
AI回复: 作为社区健康管理师，我建议从以下几个方面提升...
```

#### 实现文件位置

- **监护人端实现**: `Unified/src/modules/guardian/AIAssistant.vue`
- **政府端实现**: `Unified/src/modules/gov/AIAssistant.vue`
- **实现指南文档**: `Unified/SKILL_IMPLEMENTATION_GUIDE.md`

#### 扩展性设计

系统采用配置化设计，可以轻松扩展:

1. **添加新技能角色**: 在 `skillKeywords` 对象中添加新的技能和关键词
2. **调整关键词**: 修改现有技能的关键词数组
3. **修改动画时序**: 调整 `startSkillAnimation` 中的延时参数
4. **自定义动画效果**: 修改CSS中的transition参数
